...
class InactivityService extends GetxService {
  ...
  final _log = TagLogger('InactivityService');
  ...
  void startTimer() {
    ...
    _rxRemainingSeconds(AppDurations.inactivityTimeout.inSeconds);
    _timer = Timer.periodic(AppDurations.inactivityCheckInterval, (timer) {
      if (_rxRemainingSeconds.value > 0) {
        ...
        timer.cancel();
        _log.i("Inactivity timeout. Navigating to default route.");
        _rxId('');
